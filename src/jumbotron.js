...
const Jumbotron = () =>{
  return (<article className="header grid">
    <div className="col">
      <h2 className='jumboName heading'>Hi! I'm Chelsi Rawat.</h2>
      <p className="para">I am an undergraduate Computer Science and Engineering Student at <span className="collegeName"><a href="https://www.iitg.ac.in/" target="_blank">IIT Guwahati</a></span>.</p>
